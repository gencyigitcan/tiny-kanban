// Generator for 2026-2027 10-person team demo dataset
const fs = require('fs');
...
function generateSprints() {
    const sprints = [];
    let start = new Date('2026-01-05'); // Monday, Jan 5, 2026
    const today = new Date('2026-09-16'); // Today
    ...
    for (let i = 1; i <= 52; i++) {
        ...
        // Sprint 19 (Sept 14 - Sept 27, 2026) is active
...
function generateCards() {
    return [
        ...
        // ══════════════════════════════════════════════════════
        // ── SPRINT 19 (AKTİF SPRINT: 2026-09-14 -> 2026-09-27) ──
        // ══════════════════════════════════════════════════════
        {
            id: 'c122', key: 'TK-122',
        ...
        // ── SPRINT 20-26 (Q4 2026 UPCOMING ROADMAP) ─────────
        {
            id: 'c132', key: 'TK-132',
        ...
        // ══════════════════════════════════════════════════════
        // ── 2027 YOL HARİTASI (SPRINTS 27 - 52) ───────────────
        // ══════════════════════════════════════════════════════
        {
            id: 'c139', key: 'TK-139',
